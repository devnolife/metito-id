...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/legacy-ui/tabs"
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle } from "@/components/legacy-ui/alert-dialog"
import { Eye, Trash2, Package, Tag, DollarSign, MapPin, Clock, Shield, Truck, Loader2, Image as ImageIcon, Info } from "lucide-react"
...
export function ProductDialogs({
  ...
  const formatCurrency = (amount?: string | number) => {
    ...
    if (isNaN(numValue)) return typeof amount === 'string' ? amount : 'Rp 0'
  ...
  return (
    <>
      {/* View Product Dialog - Deprecated: Use /admin/products/[id] page instead */}
      {viewDialog && onViewClose && (
