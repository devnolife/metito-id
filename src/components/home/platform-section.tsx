...
const imageSrcSet = (base: string, ext: string) =>
  `${base}-p-500.${ext} 500w, ${base}-p-800.${ext} 800w, ${base}.${ext} 912w`;
  ...
  return (
    <section className="padding-global">
      <div className="border-x border-line pt-xxlarge pb-xhuge md:pt-xlarge md:pb-xlarge">
        {/* header */}
        <div className="flex flex-col items-start justify-start gap-4 px-6 md:mx-auto md:max-w-[30.25rem] md:items-center md:px-0 md:text-center">
                    ...
                    {pane.cards.map((card, cardIndex) => (
                      ...
                      >
                        <div className="aspect-[3/2] overflow-hidden">
                          ...
                          <img
                            src={`${card.image}.${card.ext}`}
                            srcSet={imageSrcSet(card.image, card.ext)}
                            sizes="100vw"
                            alt=""
                            width={912}
                            height={600}
