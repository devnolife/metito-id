 ...
 *
 * Pola: {NNN}/{KODE_PERUSAHAAN}-{KODE_DOK}/{BULAN_ROMAWI}/{TAHUN}
 * Contoh: 001/METITO-SPH/VII/2026
 *
 ...
 * mengubah kode.
 *
 * Bentuk baku mengikuti nomor yang benar-benar sudah terbit dan dikirim ke
 * pelanggan pada register surat (001/METITO-SPH/VII/2026 dan seterusnya),
 * sehingga surat yang beredar tidak perlu dinomori ulang. Nomor SPH yang
 * dihasilkan di sini wajib identik dengan lib/letter-number.ts; kesamaannya
 * dikunci oleh pengujian agar kedua deret tidak dapat bercabang.
 */
...
export function formatQuotationNumber({
  ...
  return `${padSeq(seq)}/${companyCode}-${docCode}/${month}/${year}`
}
